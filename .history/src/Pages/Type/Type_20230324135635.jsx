...
import pokeball from "./pokeball copy.png";
...
function Type({ valueSearch }) {
  ...
  const handleSubmit = (event) => {
    ...
    const newLocation = "http://localhost:5174/type/"+ inputValue.toLowerCase();
    ...
    return (
      <>
        ...
        <form className="group" onSubmit={handleSubmit}>
          ...
          {/* <button  type="submit"> */}
            <img  type="submit" src={pokeball} className={"valueSearchIcon"} alt="" srcset="" />
          {/* </button> */}
        </form>
        <h2>{id}</h2>
