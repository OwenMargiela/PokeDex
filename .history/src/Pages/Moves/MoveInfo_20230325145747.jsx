          ...
          <div className="headElem">
            <table className="moveDataTable">
              <tbody>
                <tr>
                  <td>Type</td>
              <Link to={`/moves/${moveData.type.name}`}>
            ...
            <div className="Effects">
              <div className="shortEffect">
                <h2>Effect</h2>
                <p>{moveData?.effect_entries[0]?.effect || 'Sorry we dont have this yet :('}</p>
              </div>
              <div className="longEffect">
                <h2>Short Effect</h2>
                <p>{moveData?.effect_entries[0]?.short_effect|| 'Sorry we dont have this yet :('}</p>
              </div>
