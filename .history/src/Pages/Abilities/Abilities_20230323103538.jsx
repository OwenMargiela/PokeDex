...
function Abilities({ valueSearch }) {
  ...
  if (abilities) {
    ...
    console.log(abilities.effect_entries.filter(entry => entry.language.name === 'en'))
      ...
      <>
        ...
        <main className="mainPokedata">
          <div className="effect">
            <h2>Effect</h2>
            <p>{abilities.effect_entries.filter(entry => entry.language.name === 'en')[0].effect}</p>
          </div>
          <div className="shortEffect">
            <h2>Short Effect</h2>
            <p>{abilities.effect_entries.filter(entry => entry.language.name === 'en')[0].short_effect}</p>
          </div>
