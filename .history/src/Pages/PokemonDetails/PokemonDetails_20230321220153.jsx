...
function PokemonDetails({ pokeEntry, pokedexText }) {
  if (pokedexText && pokeEntry.species) {
    ...
    // console.log(pokeEntry.entry)
     const total = pokeEntry.entry.stats.reduce((accumulator,currentValue)=>(
            ...
            <div className="pokedexData">
              <div className="header">
                <div className="artworkAndType">
                  <h2 className="genus">{pokedexText.genera[7].genus}</h2>
                  <img
                  ...
                  <div className="types">
                    <ul className="typesList-abilitiesList">
                      {pokeEntry.entry.types.map((type, i) => (
                        <Link className="type" to={`/type/${type.type.name}`}>
                        <li  key={i}>
                          {type.type.name}
                        </li>
                        </Link>
                  ...
                  {showModal && (
                    <div className="modal">
                      <div className="modal-content">
                        ...
                        <img className="modalSprite" src={arry[spriteNum]} alt="" srcset="" />
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="sprites">
                ...
                {arry.map((sprite,i) =>
                  sprite ? (
                    <img onClick={()=>handleShowModal(i)} className="sprite" src={sprite} alt="" srcset="" />
                  ) : null
                )}
              </div>
            </div>
