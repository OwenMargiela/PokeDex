...
function PokemonDetails({ pokeEntry, pokedexText }) {
    ...
    if (pokedexText && pokeEntry.species) {
        ...
        let uniqueEntry= new Set(pokeEntry.flavor_text_entries)
        // pokedexText.flavor_text_entries.forEach(elem => uniqueEntry.push(elem.flavor_text))
        console.log(pokeEntry.flavor_text_entries)
