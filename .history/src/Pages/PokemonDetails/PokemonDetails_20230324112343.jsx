...
function PokemonDetails({ pokeEntry, pokedexText, moves }) {
  if (pokedexText && pokeEntry.species) {
    ...
    useEffect(() => {
      ...
      //   const { data } = await axios.get(pokeEntry.entry.species.url);

      //   getEvolutionData(data);
      // }
      // async function getEvolutionData (res){
      //   const {data} = await axios.get(res.evolution_chain.url)
      //   const {chain} = data
                    ...
                    <tbody>
                      ...
                      {locationAreas.map((locaion, i) => (
                        <tr>
                          ...
                          <div>{locaion.location_area.name}</dvi>
                        
                          <Link to={`/location/${locaion.location_area.name}`}>
                          <p>search</p>
                          </Link>
                          </td>
                        </tr>
