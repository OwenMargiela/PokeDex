...
function PokemonDetails({ pokeEntry, pokedexText }) {
  if (pokedexText && pokeEntry.species) {
    ...
    const sortedMoves = moves
      .sort(
        (a, b) =>
          a.version_group_details[moves.version_group_details.length-1].level_learned_at -
          b.version_group_details[moves.version_group_details.length-1].level_learned_at
      )
          ...
          <div className="pokedexData">
            ...
            <div className="level-upMoves">
              {/* {console.log(pokeEntry.entry.moves[0].version_group_details[
                            pokeEntry.entry.moves[0].version_group_details.length - 1
                          ])} */}
