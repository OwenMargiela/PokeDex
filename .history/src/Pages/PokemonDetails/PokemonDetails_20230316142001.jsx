...
function PokemonDetails({ pokeEntry, pokedexText }) {
  if (pokedexText && pokeEntry.species) {
    ...
    //         const {data} = await axios.get(pokedexText.evolution_chain.url)
    ...
    //         // console.log(pokedexText.evolution_chain.url)
    //     }
    //     fetchEvolution()
    // },[])
                ...
                .map((move) => (
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <p>Learn Method</p>
                          <strong>Level - {move.version_group_details[move.version_group_details.length - 1].level_learned_at}</strong>
                        </td>
                      </tr>
                    </tbody>
                  </table>
